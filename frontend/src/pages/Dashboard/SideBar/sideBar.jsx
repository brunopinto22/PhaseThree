...
const SideBar = ({ type = null, summary = null, error = null }) => {
	...
	return (
		<div className='sidebar d-flex flex-column'>
			...
			{(type === "admin" || type === "academic_services") &&
				<>
					<h5>Informação:</h5>
					<div className='d-flex flex-column gap-2'>
						...
						<div className='d-flex flex-row gap-2'><i className="bi bi-clipboard-check"></i><b>Candidaturas:</b>{summary?.nCandidatures}</div>
					</div>
				</>
			}
			...
			{(type === "student" && summary !== null) &&
				<>
					...
					{summary?.calendar ? (
						...
						<Alert text="Nenhum calendário atribuído de momento." small />
					)}
